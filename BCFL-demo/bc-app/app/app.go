...
import (
	...
	appparams "github.com/FL-chain-lab-dev/BCFL-demo/bc-app/app/params"
	"github.com/FL-chain-lab-dev/BCFL-demo/bc-app/x/bcapp"
	bcappkeeper "github.com/FL-chain-lab-dev/BCFL-demo/bc-app/x/bcapp/keeper"
	bcapptypes "github.com/FL-chain-lab-dev/BCFL-demo/bc-app/x/bcapp/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/bcappd")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	bcappKeeper bcappkeeper.Keeper
...
func New(
	...
	app.bcappKeeper = *bcappkeeper.NewKeeper(
        appCodec, keys[bcapptypes.StoreKey], keys[bcapptypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		bcapp.NewAppModule(appCodec, app.bcappKeeper),
